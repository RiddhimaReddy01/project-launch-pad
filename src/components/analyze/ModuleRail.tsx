          ...
          return (
            <button
              ...
              style={{
                ...
                backgroundColor: isActive ? 'var(--text-primary)' : m.status === 'completed' ? 'rgba(45,139,117,0.08)' : 'transparent',
            ...
            >
              <div className="flex items-center gap-2.5">
                <span style={{
                  ...
                  backgroundColor: isActive ? 'var(--text-primary)' : m.status === 'completed' ? 'rgba(45,139,117,0.08)' : 'var(--surface-input)',
                  color: isActive ? '#fff' : m.status === 'completed' ? 'var(--accent-teal)' : 'var(--text-muted)',
